...
const createMockService = (): IDatabaseService => ({
  ...
  lifePodcasts: {
    list: async () => [],
    create: async (data) => ({ id: 'podcast-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
  ...
  lifePeople: {
    list: async () => [],
    create: async (data) => ({ id: 'person-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
  ...
  trips: {
    list: async () => [],
    create: async (data) => ({ id: 'trip-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
