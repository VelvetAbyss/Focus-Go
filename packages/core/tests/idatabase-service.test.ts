...
const createMockService = (): IDatabaseService => ({
  ...
  lifeDashboard: {
    get: async () => null,
    upsert: async (data) => ({ id: 'life_dashboard', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
  },
  books: {
    list: async () => [],
    create: async (data) => ({ id: 'book-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
  ...
  media: {
    list: async () => [],
    create: async (data) => ({ id: 'media-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
  ...
  stocks: {
    list: async () => [],
    create: async (data) => ({ id: 'stock-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
  ...
  lifeSubscriptions: {
    list: async () => [],
    create: async (data) => ({ id: 'life-subscription-1', createdAt: Date.now(), updatedAt: Date.now(), ...data }),
    update: async (id, patch) => ({
      id,
      createdAt: Date.now(),
      updatedAt: Date.now(),
