  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'group relative cursor-pointer rounded-lg border bg-card shadow-[0_10px_26px_rgba(15,23,42,0.04)] transition-[transform,box-shadow] duration-200 ease-out',
      ...
      >
        {priorityKey !== 'none' ? <div className={cn('absolute right-4 top-0 h-0.5 w-8 rounded-b', priorityCfg.dot)} /> : null}
        ...
        <div className="space-y-2.5 p-3.5">
          ...
          <div
            className={cn(
              'flex items-center gap-0.5 border-t border-transparent pt-1 transition-all duration-150',
              isHovered || progressComposer?.isOpen ? 'opacity-100' : 'h-0 overflow-hidden pt-0 opacity-0',
            )}
